        ...
        <div className='max-w-[500px] p-4 lg:p-8'>
...

            {
                <form onSubmit={submitHandler}>
                        ...
                        <>
                            <div>
                                ...
                                <input 
                                    ...
                                    className='w-full rounded-[0.5rem] p-[12px] text-richblack-5 border-gray-500 border-2'
                    ...
                    <button className='mt-6 w-full rounded-[8px] bg-[#20B486] py-[12px] px-[12px] font-medium text-white'>{emailSent ?`Resend Mail` : `Reset Password`}</button>
                </form>
            }
