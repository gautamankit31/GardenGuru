...
const VerifyOtp = () => {
  ...
  const submitHandler = (event) => {
    ...
    const { firstName, lastName, email, password,pincode, confirmPassword, accountType } = signupData;
    dispatch(signup(accountType, firstName, lastName, email,pincode, password, confirmPassword, otp, navigate));
  }
