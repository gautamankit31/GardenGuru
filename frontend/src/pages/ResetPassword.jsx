    ...
    <div className='grid min-h-[calc(100vh-3.5rem)] place-items-center'>
        <div className='max-w-[500px] p-4 lg:p-8'>
            ...
            <form onSubmit={submitHandler}>
                <div className='flex flex-col gap-4'>
                    <div className='relative'>
                        ...
                        <input 
                            ...
                            className='w-full rounded-[0.5rem] bg-richblack-800 p-[12px] text-richblack-5 border-gray-200 border-2'
                    ...
                    <div className='relative'>
                        ...
                        <input 
                            ...
                            onChange={changeHandler} className='w-full rounded-[0.5rem] bg-richblack-800 p-[12px] text-richblack-5 border-gray-200 border-2'
                ...
                <button type='text' className='mt-6 rounded-[8px] bg-[#20B486] py-[8px] px-[12px] font-semibold text-white w-full'>Reset Password</button>
            </form>
