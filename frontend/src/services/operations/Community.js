...
import {setCommunities,setCurrentCommunity,setLoading,setMembers,setPosts,addCommunity,addMember,removeCommunity,removeMember,addPost,removePost} from '../../slices/CommunitySlice';
...
export const getAllCommunities = (token) => {
    return async (dispatch) => {
        ...
        try {
            const response = await apiConnector("GET", communityEndpoints.GET_ALL_COMMUNITIES_API,null,{Authorization: `Bearer ${token}`});
            console.log("GET ALL COMMUNITIES API RESPONSE............", response.data);
...
export const getCommunity = (communityId) => {
    return async (dispatch) => {
        ...
        dispatch(setLoading(true));
        try {
            const response = await apiConnector("POST", communityEndpoints.GET_COMMUNITY_API, { communityId });
...
export const getMembers = (communityId) => {
    return async (dispatch) => {
        ...
        dispatch(setLoading(true));
        try {
            const response = await apiConnector("POST", communityEndpoints.GET_MEMBERS_API, { communityId });
...
export const getPosts = (communityId) => {
    return async (dispatch) => {
        ...
        dispatch(setLoading(true));
        try {
            const response = await apiConnector("POST", communityEndpoints.GET_POSTS_API, { communityId });
...
export const createCommunity = (name, description) => {
    return async (dispatch) => {
        ...
        dispatch(setLoading(true));
        try {
            const response = await apiConnector("POST", communityEndpoints.CREATE_COMMUNITY_API, { name, description });
...
export const joinCommunity = (communityId) => {
    return async (dispatch) => {
        ...
        dispatch(setLoading(true));
        try {
            const response = await apiConnector("POST", communityEndpoints.JOIN_COMMUNITY_API, { communityId });
...
export const leaveCommunity = (communityId) => {
    return async (dispatch) => {
        ...
        dispatch(setLoading(true));
        try {
            const response = await apiConnector("POST", communityEndpoints.LEAVE_COMMUNITY_API, { communityId });
...
export const deleteCommunity = (communityId) => {
    return async (dispatch) => {
        ...
        dispatch(setLoading(true));
        try {
            const response = await apiConnector("POST", communityEndpoints.DELETE_COMMUNITY_API, { communityId });
...
export const updateCommunity = (communityId, name, description) => {
    return async (dispatch) => {
        ...
        dispatch(setLoading(true));
        try {
            const response = await apiConnector("POST", communityEndpoints.UPDATE_COMMUNITY_API, { communityId, name, description });
...
export const addThePost = (communityId, description, image) => {
    return async (dispatch) => {
        ...
        try {
            ...
            const response = await apiConnector("POST", communityEndpoints.ADD_POST_API, formData, {
                headers: {
...
export const deletePost= (postId) => {
    return async (dispatch) => {
        ...
        dispatch(setLoading(true));
        try {
            const response = await apiConnector("POST", communityEndpoints.DELETE_POST_API, { postId });
